...
1. **Reciter** -- rule-based English text to phoneme conversion
2. **Phoneme processor** -- phoneme parsing, stress assignment, and duration rules
3. **Renderer** -- three-formant additive synthesis with timetable-accurate output

An optional native C module provides ~100x faster rendering on the RP2040.
